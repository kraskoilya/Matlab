...
% Last Modified by GUIDE v2.5 19-Dec-2017 21:39:45
...
scatter(V0(1),V0(2));
set(handles.text2,'String',fun(V0));
set(handles.text3,'String',V0(1)); 
set(handles.text4,'String',V0(2)); 
...
% hObject    handle to funEdit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of funEdit as text
%        str2double(get(hObject,'String')) returns contents of funEdit as a double
